...
- **Changing the skill itself:** copy `skills/meta-campaign-builder/` into `.claude/skills/` in your project and disable the plugin (`/plugin`). Your copy is then yours, and updates stop touching it.
